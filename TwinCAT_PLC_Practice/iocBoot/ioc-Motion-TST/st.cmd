...
#
#         Project: TwinCAT_PLC_Practice.tsproj
#        PLC name: Motion_TST (Motion_TST Instance)
...
epicsEnvSet("LOCATION", "PLC:Motion_TST" )
...
epicsEnvSet("ADS_MAX_PARAMS",   "1165")
...
epicsEnvSet("PREFIX",         "PLC:Motion_TST:")
...
epicsEnvSet("MOTOR_PREFIX",    "PRACTICE:")
epicsEnvSet("MOTOR_NAME",      "PLC_MOT")
...
dbLoadRecords("iocSoft.db", "IOC=PLC:Motion_TST")
dbLoadRecords("save_restoreStatus.db", "P=PLC:Motion_TST:")
dbLoadRecords("caPutLog.db", "IOC=$(IOC)")

## TwinCAT task, application, and project information databases ##
dbLoadRecords("TwinCAT_TaskInfo.db", "PORT=$(ASYN_PORT),PREFIX=PLC:Motion_TST,IDX=1")
dbLoadRecords("TwinCAT_AppInfo.db", "PORT=$(ASYN_PORT), PREFIX=PLC:Motion_TST")

dbLoadRecords("TwinCAT_Project.db", "PREFIX=PLC:Motion_TST,PROJECT=TwinCAT_PLC_Practice.tsproj,HASH=unknown,VERSION=unknown,PYTMC=2.15.2.dev0+g73bd2d9.d20230727,PLC_HOST=172.21.148.87")

#   lcls-twincat-motion: * -> * (SLAC)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:Motion_TST,DEPENDENCY=lcls-twincat-motion,VERSION=*,VENDOR=SLAC")
#   Tc2_Standard: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:Motion_TST,DEPENDENCY=Tc2_Standard,VERSION=*,VENDOR=Beckhoff Automation GmbH")
#   Tc2_System: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:Motion_TST,DEPENDENCY=Tc2_System,VERSION=*,VENDOR=Beckhoff Automation GmbH")
#   Tc3_Module: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:Motion_TST,DEPENDENCY=Tc3_Module,VERSION=*,VENDOR=Beckhoff Automation GmbH")

cd "$(IOC_TOP)"

## PLC Project Database files ##
dbLoadRecords("Motion_TST.db", "PORT=$(ASYN_PORT),PREFIX=PLC:Motion_TST:,IOCNAME=$(IOC),IOC=$(IOC)")

# Total records: 165
callbackSetQueueSize(2330)

# Autosave and archive settings:
save_restoreSet_status_prefix("PLC:Motion_TST:")
